    ...
    <div class="panel-heading with-icon">
        {if $sub_view == ""}
            <div class="pull-right flip">
                <a href="{$system['system_url']}/admin/announcements/add" class="btn btn-primary">
                ...
                <table class="table table-striped table-bordered table-hover js_dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{$row['end_date']}</td>
                            <td>
                                <button class="btn btn-xs btn-danger js_admin-deleter" data-handle="announcement" data-id="{$row['announcement_id']}">
                                    <i class="fa fa-trash-o"></i>
                                </button>
                                <a href="{$system['system_url']}/admin/announcements/edit/{$row['announcement_id']}" class="btn btn-xs btn-primary">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" name="type">
                            <option {if $data['type'] == "success"}selected{/if} value="success" class="alert-success">Success</option>
                            <option {if $data['type'] == "warning"}selected{/if} value="warning" class="alert-warning">Warning</option>
                            <option {if $data['type'] == "danger"}selected{/if} value="danger" class="alert-danger">Danger</option>
                            <option {if $data['type'] == "info"}selected{/if} value="info" class="alert-info">Info</option>
                        </select>
                    </div>
                </div>
