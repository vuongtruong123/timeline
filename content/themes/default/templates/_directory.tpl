<div class="container">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-4">
            <a href="{$system['system_url']}/directory/posts" class="panel-directory">
                <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/directory/newsfeed.png">
                <div class="title">{__("News Feed")}</div>
                <p>
        ...
        <div class="col-xs-12 col-sm-4">
            <a href="{$system['system_url']}/directory/users" class="panel-directory">
        ...
        <div class="col-xs-12 col-sm-4">
            <a href="{$system['system_url']}/directory/pages" class="panel-directory">
        ...
        <div class="col-xs-12 col-sm-4">
            <a href="{$system['system_url']}/directory/groups" class="panel-directory">
        ...
        <div class="col-xs-12 col-sm-4">
            <a href="{$system['system_url']}/directory/games" class="panel-directory">
                <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/directory/photos.png">
                <div class="title">{__("Games")}</div>
                <p>
        ...
        <div class="col-xs-12 col-sm-4">
            <a href="{$system['system_url']}/search" class="panel-directory">
                <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/directory/search.png">
                <div class="title">{__("Search")}</div>
                <p>
                    {__("Stay ahead of the world. Keep an eye on what's trending around")}
                </p>
            </a>
        </div>
    </div>
