            ...
            <div class="panel panel-default">
                <div class="panel-body with-nav">
                    <ul class="side-nav metismenu js_metisMenu">
                        ...
                        <!-- Design -->
                        <li {if $view == "design"}class="active selected"{/if}>
                            <a href="{$system['system_url']}/admin/design">
                        ...
                        <li {if $view == "announcements"}class="active"{/if}>
                            <a href="{$system['system_url']}/admin/announcements">
                                <i class="fa fa-bullhorn fa-fw fa-lg pr10"></i>{__("Announcements")}
                                <span class="fa arrow"></span>
                            </a>
                            <ul>
                                <li {if $view == "announcements" && $sub_view == ""}class="active selected"{/if}>
                                    <a href="{$system['system_url']}/admin/announcements">
                                        <i class="fa fa-caret-right fa-fw pr10"></i>{__("Lists")}
                                    </a>
                                </li>
                                <li {if $view == "announcements" && $sub_view == "add"}class="active selected"{/if}>
                                    <a href="{$system['system_url']}/admin/announcements/add">
                                        <i class="fa fa-caret-right fa-fw pr10"></i>{__("Add New")}
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li>
                            <div class="static">
                                <i class="fa fa-copyright fa-fw fa-lg pr10"></i>{__("Build")} v{$system['version']}
                            </div>
                        </li>
                        <!-- Build -->
