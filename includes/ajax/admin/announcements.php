...
try {
	...
	switch ($_GET['do']) {
		case 'edit':
			...
			/* return */
			return_json( array('success' => true, 'message' => __("Done, Announcement info have been updated")) );
			break;
		...
		case 'add':
			...
			/* return */
			return_json( array('callback' => 'window.location = "'.$system['system_url'].'/admin/announcements";') );
			break;
