...
function initialize() {
    ...
    // run videojs plugin
    $('video.js_video-js').each(function(){
        videojs($(this)[0], {}, function() {});
    });
    // run mediaelementplayer plugin
    $('audio.js_mediaelementplayer').mediaelementplayer();
}
...
function see_more(element) {
    ...
    /* prepare data object */
    var data = {};
    data['get'] = _this.attr('data-get');
    if(_this.attr('data-filter') !== undefined) {
        data['filter'] = _this.attr('data-filter');
    }
    if(_this.attr('data-type') !== undefined) {
        data['type'] = _this.attr('data-type');
    }
    if(_this.attr('data-uid') !== undefined) {
        data['uid'] = _this.attr('data-uid');
    }
    if(_this.attr('data-id') !== undefined) {
        data['id'] = _this.attr('data-id');
    }
    data['offset'] = _this.attr('data-offset') || 1; /* we start from iteration 1 because 0 already loaded */
